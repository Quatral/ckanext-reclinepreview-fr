...
(function(my) {
  ...
  my.dataproxy_url = 'http://vds-ckan.quatral.com/dataproxy';
    ...
    <div class="recline-flot"> \
      <div class="panel graph" style="display: block;"> \
        <div class="js-temp-notice alert alert-block"> \
          <h3 class="alert-heading">Bonjour !</h3> \
          <p>Il n\'y a pas encore graphique ici parce que nous ne savons pas quel sont les champs que vous souhaitez voir tracée.</p> \
          <p>S\'il vous plaît nous dire en <strong>utilisant le menu sur la droite</strong> et un graphique s\'affiche automatiquement.</p> \
        </div> \
      </div> \
    </div> \
',
  ...
  <div class="editor"> \
    <form class="form-stacked"> \
      <div class="clearfix"> \
        ...
        <label>Colonne Groupe (Axe 1)</label> \
      ...
      <div class="editor-buttons"> \
        <button class="btn editor-add">Ajouter Series</button> \
      </div> \
...
',
  templateSeriesEditor: ' \
    <div class="editor-series js-series-{{seriesIndex}}"> \
      <label>Series <span>{{seriesName}} (Axe 2)</span> \
        [<a href="#remove" class="action-remove-series">Supprimer</a>] \
      </label> \
      <div class="input"> \
        <select> \
        {{#fields}} \
    ...
    <form class="form-stacked"> \
      <div class="clearfix"> \
        ...
        <div class="editor-field-type-geom" style="display:none"> \
          <label>Champ géométrie (GeoJSON)</label> \
  ...
  template: ' \
    <form action="" method="GET" class="form-inline"> \
      <div class="input-prepend text-query"> \
        ...
        <input type="text" name="q" value="{{q}}" class="span2" placeholder="Recherche ..." class="search-query" /> \
      </div> \
      <button type="submit" class="btn">Aller &raquo;</button> \
    </form> \
  ',
...
my.ValueFilter = Backbone.View.extend({
  ...
  template: ' \
    <div class="filters"> \
      <h3>Filtres</h3> \
      <button class="btn js-add-filter add-filter">Ajouter un filtre</button> \
      <form class="form-stacked js-add" style="display: none;"> \
        <fieldset> \
          <label>Champ</label> \
          <select class="fields"> \
